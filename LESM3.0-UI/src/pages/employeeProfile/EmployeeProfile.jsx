...
function EmployeeProfile({ props }) {
  ...
  return (
    <>
      ...
      <p style={{margin:"118px",color:"red",fontWeight:"bold"}}>No Allowances Present</p>
    )}
          {/* </div> */}
        </>
      )}
      ...
      {showClients && (
        <>
           {data.employeeAtClientsDetails && data.employeeAtClientsDetails.length > 0 ? (
          <div
            style={{
              overflowY: "scroll",
              maxHeight: "400px",
          ...
          >
            ...
            <p style={{margin:"118px",color:"red",fontWeight:"bold"}}>No Clients Present</p>
           )}
        </>
      )}
       {showEmployees ? (
  employee && employee.length > 0 ? (
        ...
        <p style={{margin:"118px",color:"red",fontWeight:"bold"}}>No Employees Present</p>
      )
    ) : null}
      {/* </div> */}
    </>
